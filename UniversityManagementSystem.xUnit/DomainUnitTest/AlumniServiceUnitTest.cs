...
namespace UniversityManagementSystem.UnitTest.DomainUnitTest
{
    public class AlumniServiceUnitTest
    {
        ...
        {
            var id = 1;
            Alumni expectedAlumni=new Alumni { FirstName = "John Wick"};
            ...
            Assert.Equal(expectedAlumni.FirstName, result.FirstName);
        ...
        public async Task GetAllAlumniAsync_GetSuccess_ReturnList()
        {
            ...
            {
                new Alumni() {FirstName = "Test1"},
                new Alumni() {FirstName = "Test2"},
            };
